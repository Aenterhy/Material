...
open class TextField: UITextField {
    ...
    open var isClearIconButtonEnabled: Bool {
        ...
        set(value) {
            ...
            clearIconButton = IconButton(image: UIImage(named: "cm_close_white"), tintColor: placeholderNormalColor)
...
fileprivate extension TextField {
    ...
    func prepareDetailLabel() {
        detailLabel.font = UIFont.systemFont(ofSize: 12) //RobotoFont.regular(with: 12)
    ...
    func handleVisibilityIconButton() {
        ...
        UIView.transition(
            ...
            animations: { [weak self] in
                ...
                guard self.visibilityIconButton != nil else {
                    return
                }
